...
function ChechBoxMon() {
    ...
    <label for="time2"> 8:30 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time3" name="time3" value="time3"/>
    <label for="time3"> 9:00 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time4" name="time4" value="time4"/>
    <label for="time4"> 9:30 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time5" name="time5" value="time5"/>
    <label for="time5"> 10:00 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time6" name="time6" value="time6"/>
    <label for="time6"> 10:30 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time7" name="time7" value="time7"/>
    <label for="time7"> 11:00 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time8" name="time8" value="time8"/>
    <label for="time8"> 11:30 AM</label>
    </div>
    
    <div className='theCheck'>
        <input type="checkbox" id="time9" name="time9" value="time9"/>
    <label for="time9"> 12:00 PM</label>
    </div>
